...
NOTE:
Editors with access to authoritative sources are encouraged to seek and resolve these mysteries within the entire collection. (by searching for literal unquoted '[?')
