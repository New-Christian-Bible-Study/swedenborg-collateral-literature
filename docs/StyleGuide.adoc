...
// As in the header above for :doctype:, two slashes start a comment line. As in the block below, four slashes start and end a comment block.

////
Editors' comments and notes


(end of Editors' comments
////
