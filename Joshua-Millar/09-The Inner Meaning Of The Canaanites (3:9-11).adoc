...
Finally we come to the Jubusites. In the Prophets, the Jubusites are described as having an Amorite as a father and a Hittite for a mother.
...
all elements pointing to the negative behaviours that issue forth from the proprium when it is self absorbed instead of centred on the things of the Lord as the Word.
