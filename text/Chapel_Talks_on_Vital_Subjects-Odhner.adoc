...
The birth of the Lord on earth is said to signify man's regeneration; the work or John the Baptist, that which the Writings call reformation. Reformation and regeneration what are they, and what is the difference between them?
...
Canaan, on the other hand, (the Promised Land, it was called), obviously signifies heaven; or, putting it another way, man's heavenly destiny, which is regeneration. This, of course, in reference to Abraham's and Israels return to Canaan. In reference to the Lord, Canaan signifies even more His glorification or the making Divine of His assumed human mind and character.
